...
<head>
    ...
    <link rel="stylesheet" href="<c:url value='/css/teacher-subject/profile.css'/>">
</head>
<body>
<div class="layout">
    ...
    <main class="main teacher-info-page teacher-profile-page">
        <header class="topbar">
            <div class="topbar-left">
                ...
                <p>Xem toàn bộ hồ sơ giáo viên bộ môn và cập nhật email, ảnh đại diện, số điện thoại.</p>
            </div>
        </header>
        ...
        <section class="content">
            ...
            <div class="card profile-summary">
                ...
                <div class="profile-main">
                    ...
                    <div class="profile-pills">
                        ...
                        <span class="info-pill">Lớp bộ môn phụ trách: ${teacherInfo.currentSubjectClasses}</span>
                    </div>
                </div>
            </div>
            ...
            <div class="card profile-edit-card">
                ...
                <form method="post" action="<c:url value='/teacher-subject/profile'/>" enctype="multipart/form-data" class="profile-edit-form">
