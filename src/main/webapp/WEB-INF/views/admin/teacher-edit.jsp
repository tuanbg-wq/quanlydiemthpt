  ...
  <main class="main teacher-create-page teacher-edit-page">
    <header class="topbar">
      <div class="topbar-left">
        <h1>Chá»‰nh sá»­a giĂ¡o viĂªn</h1>
        <p>Cáº­p nháº­t há»“ sÆ¡ giĂ¡o viĂªn vĂ  vai trĂ² nghiá»‡p vá»¥.</p>
      </div>
    </header>
        ...
        <form id="teacherEditForm"
                ...
                <c:choose>
                  <c:when test="${not empty currentAvatar}">
                    ...
                    <img id="avatarPreview"
                         alt="Preview áº£nh giĂ¡o viĂªn"
                         src="${avatarPreviewUrl}"
                         data-initial-src="${avatarPreviewUrl}">
                    <span id="avatarPreviewEmpty" hidden>ChÆ°a chá»n áº£nh</span>
                  </c:when>
                  <c:otherwise>
                    <img id="avatarPreview"
                         alt="Preview áº£nh giĂ¡o viĂªn"
          ...
          <div class="form-bottom">
            ...
            <div class="actions">
              ...
              <button type="button" class="btn" id="resetFormBtn">HoĂ n tĂ¡c</button>
              <button type="submit" class="btn primary" id="saveTeacherBtn">LÆ°u cáº­p nháº­t</button>
            </div>
          </div>
        </form>
      </section>
