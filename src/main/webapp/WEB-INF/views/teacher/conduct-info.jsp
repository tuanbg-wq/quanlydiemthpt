  ...
  <main class="main conduct-info-page">
    <section class="info-card">
      ...
      <div class="form-actions-bottom">
        <a class="btn btn-outline" href="<c:url value='/teacher/conduct'/>">Quay lại danh sách</a>
        <a class="btn btn-primary" href="<c:url value='/teacher/conduct/${detail.eventId}/edit'/>">Chỉnh sửa</a>
      </div>
    </section>
  </main>
</div>
