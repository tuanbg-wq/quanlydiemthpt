...
The app stores avatars in a filesystem folder configured by `app.upload.dir`.

- Default (local): `uploads`
- Production profile default: `/var/webdiem/uploads`
- Override on server with env var: `APP_UPLOAD_DIR`

Example (Linux):

```bash
export SPRING_PROFILES_ACTIVE=prod
export APP_UPLOAD_DIR=/data/webdiem/uploads
